...
/**
 * Exception that is thrown when the hydration of an aggregate fails. This can occur during the
 * loading from a repository as well as during the "apply" methods when there is a reflection based
 * exception.
 */
